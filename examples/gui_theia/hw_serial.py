                ...
                while stay_connected:
                    ...
                    if not self.action_recipe.empty():
                        ...
                        if rec == "init":
                            ...
                            self.__ser_send(ser, "M240 A250 B250 C600")                 # Set motor drive speed #TODO: remove and use use config settings from main
                        ...
                        if rec == "seek_a":
                            ...
                            self.__ser_send(ser, "G0 A1")        # move forward (and move back to find PI to eliminate hysteresis)
                            ...
                            self.__ser_send(ser, "G0 A-1000")       # still using relative coordinate system move a bit
                            self.__wait_till_stop(ser, 1, CHA_MOVE) # Wait until homing is over
                            self.__ser_send(ser, "G92 A0")          # set current coordinate to 0
                        ...
                        if rec == "seek_b":
                            ...
                            self.__ser_send(ser, "G0 B1")        # move forward (and move back to find PI to eliminate hysteresis)
                            ...
                            self.__ser_send(ser, "G0 B-1000")       # still using relative coordinate system move a bit
                            self.__wait_till_stop(ser, 1, CHB_MOVE) # Wait until homing is over
                            self.__ser_send(ser, "G92 B0")          # set current coordinate to 0
                            self.__ser_send(ser, "G90")
                        ...
                        if rec == "seek_c":
                            ...
                            self.__ser_send(ser, "G0 C-1800")        # move forward (and move back to find PI to eliminate hysteresis)
